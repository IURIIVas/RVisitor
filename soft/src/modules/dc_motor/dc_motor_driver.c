...
void pwm_for_dc_change_speed(uint32_t *dc_motor_speed_pwm)
{
    ...
    RS_PWM_TIM->CH1CVR = dc_motor_speed_pwm[2];
    RS_PWM_TIM->CH2CVR = dc_motor_speed_pwm[2];

    RS_PWM_TIM->CH3CVR = dc_motor_speed_pwm[3];
    RS_PWM_TIM->CH4CVR = dc_motor_speed_pwm[3];
